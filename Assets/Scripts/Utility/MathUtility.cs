...
public static class MathUtility
{
    ...
    public static bool RaySphere(Vector3 centre, float radius, Vector3 rayOrigin, Vector3 rayDir,
        out Vector3 intersectionPoint)
    {
        // See: http://viclw17.github.io/2018/07/16/raytracing-ray-sphere-intersection/
        var offset = rayOrigin - centre;
        var a = Vector3.Dot(rayDir, rayDir); // sqr ray length (in case of non-normalized rayDir)
